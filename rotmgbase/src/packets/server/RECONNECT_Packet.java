...
public class RECONNECT_Packet implements RWable {
	...
	public void parseFromInput(ByteArrayDataInput badi) throws IOException {
		...
		this.fromarena_ = badi.readBoolean(); 
	...
	public void writeToOutput(ByteArrayDataOutput bado) throws IOException {
		...
		bado.writeBoolean(fromarena_); // Boolean
		bado.writeShort(key_.length);
		bado.write(key_);
		
		System.out.println(key_.length);
...
public String toString() {
		return "RECONNECT [" + name_ + " , " + host_ + " , " + port_ + " , " + gameId_ + " , " + keyTime_ + " , " + fromarena_ + " ," + (key_ == null ? null : DatatypeConverter.printHexBinary(key_)) + "]";
	}
}
