...
public class HELLO_Packet implements RWable {
	...
	public String toString() {
		return "HELLO [" + buildVersion_ + " , " + gameId_ + " , " + guid_ + " , " + password_ + " , " + secret_ + " , " + keyTime_ + " , " + key_.length + " , " + (key_ == null ? null : DatatypeConverter.printHexBinary(key_)) + " , " + jD + " , " + pk + " , " + Tq + " , " + H + " , " + playPlatform +  " , " + unknow1 +"]";
	}
}
